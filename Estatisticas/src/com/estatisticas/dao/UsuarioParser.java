...
public class UsuarioParser {
	...
	public static String getLoginString(final Usuario usuario) {
	...
	public static String getUpdateLoginString(final String newLogin) {
	...
	public static String getUpdatePasswordString(final String newPassword) {
